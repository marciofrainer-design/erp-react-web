...
const InputGroupBase = ({ children, width, height }: InputGroupBaseProps) => {
  ...
  const classNameClass = `w-full bg-surface-container-lowest shadow-sm rounded-md pr-4 focus:ring-2 focus:ring-primary/40 transition-all placeholder:text-outline/60 outline-none h-21 mb-2 border-none placeholder:text-base ${widthClass} ${heightClass}`;
